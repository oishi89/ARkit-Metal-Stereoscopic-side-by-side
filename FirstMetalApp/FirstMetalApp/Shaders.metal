...
fragment float4 anchorGeometryFragmentLighting(ColorInOut in [[stage_in]],
                                               ...
                                               texture2d<float, access::sample> videoTextureY [[ texture(kVideoTextureIndexY) ]],
                                               texture2d<float, access::sample> videoTextureCbCr [[ texture(kVideoTextureIndexCbCr) ]]) {
    ...
    if (in.colorID >= 4) {
        ...
        // Sample Y and CbCr textures to get the YCbCr color at the given texture coordinate
        float4 ycbcr = float4(videoTextureY.sample(colorSampler, in.texCoord).r,
                              videoTextureCbCr.sample(colorSampler, in.texCoord).rg, 1.0);
